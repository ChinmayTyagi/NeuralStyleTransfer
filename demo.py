...
def process_image(content_path, style_path):
    ...
    content_layers_names = ['block5_conv2']
    ...
    return tensor_to_image(image)[0]
    
	
result = process_image('media/landscape.jpg', 'media/apples.jpg')
result.save('output-cw_' + str(beta) + '-sw_' + str(alpha) + '-vw_' + str(total_variation_weight) + '.jpg')